...
const Create = () => {
  ...
  const navigate = useNavigate()
    ...
    // if(firstName && lastName && email && date && venue && agenda && phone && eventname){
    ...
    const handleSubmit = (e) =>{
      ...
      // if(true){
      //   alert(`Hello ${lastName} Kindly confirm the informations`)
      
      //   if (true){
      //     alert(`${lastName} are you sure your information is correct`)
      //   }
      // }
...
//   const handleSubmit = (e) =>{
//       e.preventDefault()
//       alert(`kindly confirm this details before submitting to 😊`)
//       // setIsPending(true)
//       const create = { 
//         firstName,
//         lastName, 
